...
N        0.0000000000      0.0000000000      1.274
"""
BASIS    = "cc-pVTZ"
CHARGE   = 0
...
def run_ks(mol, functional, dm0):
    ...
    mf.grids.prune = None
    mf.kernel(dm0=dm0)        # <-- seed from UHF density
...
def difference_density_nned(P_ks, P_hf, S):
    ...
    delta = np.linalg.eigvalsh(dP_orth)
...
if __name__ == "__main__":
    ...
    delta_a, ned_a = difference_density_nned(P_ks_a, P_hf_a, S)
    delta_b, ned_b = difference_density_nned(P_ks_b, P_hf_b, S)
